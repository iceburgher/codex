    ...
    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
      {results.map((r, i) => {
        ...
        return (
          <article
            key={r.scenario}
            className={`card p-5 print-block ${i === best ? "border-accent ring-2 ring-accent/30" : ""}`}
          >
            ...
            <div className="mb-4">
              ...
              <p
                className={`numeric text-2xl font-semibold tracking-tight ${
                  !blocked && r.netAvailablePrivately < 0 ? "text-negative" : ""
                }`}
              >
            ...
            <dl className="space-y-2 text-sm">
              ...
              />
              <Line label="Kapital som binds" value={formatMoney(r.cashFlow.peakCashRequirement)} />
              <Line
            ...
            {redFlags > 0 && (
              <p className="mt-4 rounded-lg bg-negative-soft px-3 py-2 text-xs font-medium text-negative">
